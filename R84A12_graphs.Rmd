...
print(pathnamesdf[39,])
```
```{r}
pathnamesdf <- rbind(pathnamesdf, "/Users/michellebang/st research lab/spatialanalysis/LabWorkNathan-master/Data_for_Analysis/all_xml_files/X401x492-2m1.xml")

pathnamesdf <- rbind(pathnamesdf, "/Users/michellebang/st research lab/spatialanalysis/LabWorkNathan-master/Data_for_Analysis/all_xml_files/X401x492-3m1.xml")

pathnamesdf <- rbind(pathnamesdf, "/Users/michellebang/st research lab/spatialanalysis/LabWorkNathan-master/Data_for_Analysis/all_xml_files/X403x492-1m4.xml")
```
...
listData = list(testdf1, testdf2, testdf3, testdf4,
                ...
                testdf25, testdf26, testdf27, testdf28, testdf29, testdf30, testdf31, testdf32, testdf33, testdf34, testdf35, testdf36, testdf37, testdf38, testdf39, testdf40, testdf41, testdf42, testdf43, testdf44)

titleList <- as.list(basename(filenames))
titleList <- append(titleList, "X401x492-2m1.xml")
titleList <- append(titleList, "X401x492-3m1.xml")
titleList <- append(titleList, "X403x492-1m4.xml")
```
...
```{r}
pdf(file = "/Users/michellebang/st research lab/spatialanalysis/SpatialAnalysisMichelle/R84A12male.pdf",
    width = 4,
    height = 4,)
for (i in 1:44) {
...
pdf(file = "/Users/michellebang/st research lab/spatialanalysis/SpatialAnalysisMichelle/R84A12TransmissionRatePlots.pdf",
    width = 4,
    height = 4,)
...
pdf(file = "/Users/michellebang/st research lab/spatialanalysis/SpatialAnalysisMichelle/R84A12GFPWTPlots.pdf",
    width = 4,
    height = 4,)
...
#commenting this out as this method is not working
  #for(i in 1:30){
   # final_df %>%
    #mutate(bins[i] = i)
  #}
...
pdf(file = "/Users/michellebang/st research lab/spatialanalysis/SpatialAnalysisMichelle/R84A12GFPWTPlots16.pdf",
    width = 4,
    height = 4,)
